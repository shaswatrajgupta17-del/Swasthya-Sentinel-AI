...
**Phase 4 - Frontend connected with FastAPI backend: completed.**
All frontend pages fetch live data from http://localhost:8000. Dashboard fetches /locations, /risks, /signals/summary, and /alerts. The Alerts page independently fetches /alerts. Loading and error states are present on both pages. Synthetic data disclaimer and no-diagnosis copy are preserved on every screen. No ML model, Azure integration, or n8n workflow has been created.
